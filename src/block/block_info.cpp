...
uint256 block_info2::nBestChainTrust = 0;
uint256 block_info2::nBestInvalidTrust = 0;
uint256 block_info2::hashBestChain = 0;
...
unsigned char block_info2::gpchMessageStart[4] = { 0xe4, 0xe8, 0xe9, 0xe5 };
