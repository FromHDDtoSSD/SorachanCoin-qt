...
uint64_t static inline ReadLE64(const unsigned char *ptr)
{
    ...
    return endian::bc_le64toh(x);
}

void static inline WriteLE16(unsigned char *ptr, uint16_t x)
{
    uint16_t v = endian::bc_htole16(x);
    std::memcpy(ptr, (char *)&v, 2);
}

void static inline WriteLE32(unsigned char *ptr, uint32_t x)
{
    uint32_t v = endian::bc_htole32(x);
    std::memcpy(ptr, (char *)&v, 4);
}

void static inline WriteLE64(unsigned char *ptr, uint64_t x)
{
    uint64_t v = endian::bc_htole64(x);
...
uint64_t static inline ReadBE64(const unsigned char *ptr)
{
    uint64_t x;
    std::memcpy((char *)&x, ptr, 8);
    return endian::bc_be64toh(x);
}

void static inline WriteBE32(unsigned char *ptr, uint32_t x)
{
    uint32_t v = endian::bc_htobe32(x);
    std::memcpy(ptr, (char *)&v, 4);
}

void static inline WriteBE64(unsigned char *ptr, uint64_t x)
{
    uint64_t v = endian::bc_htobe64(x);
    std::memcpy(ptr, (char *)&v, 8);
}
