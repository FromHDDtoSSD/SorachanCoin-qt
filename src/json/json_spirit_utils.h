...
namespace json_spirit
{
    ...
    void obj_to_map(const Obj_t &obj, Map_t &mp_obj) noexcept {
        mp_obj.clear();
    ...
    template<typename Obj_t, typename Map_t>
    void map_to_obj(const Map_t &mp_obj, Obj_t &obj) noexcept {
        obj.clear();
...
# endif
    ...
    const typename Object_type::value_type::Value_type &find_value(const Object_type &obj, const String_type &name) noexcept {
