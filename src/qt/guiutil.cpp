...
{
    // Convert SorachanCoin:// to novacoin:
    //
...
{
    return iofs::GetSpecialFolderPath(CSIDL_STARTUP) / "SorachanCoin.lnk";
}
...
{
    return GetAutostartDir() / "SorachanCoin.desktop";
}
    ...
    QMessageBox(parent)
{
    ...
    setWindowTitle(tr("SorachanCoin-qt"));
