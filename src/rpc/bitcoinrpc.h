...
class CRPCTable
{
    ...
    friend class RPCExecutor;
#endif

    friend class bitrpc;

private:
    CRPCTable(const CRPCTable &)=delete;
    CRPCTable &operator=(const CRPCTable &)=delete;
...
public:
    ...
    static json_spirit::Value importprivethkey(const json_spirit::Array &params, bool fHelp);
    ...
    static json_spirit::Value createhdwallet(const json_spirit::Array &params, bool fHelp);
    static json_spirit::Value restorehdwallet(const json_spirit::Array &params, bool fHelp);
    static json_spirit::Value getaccountaddress(const json_spirit::Array &params, bool fHelp);
    static json_spirit::Value getaccountqaiaddress(const json_spirit::Array &params, bool fHelp);
    static json_spirit::Value getaccountschnorraddress(const json_spirit::Array &params, bool fHelp);
    ...
    static json_spirit::Value sendethfrom(const json_spirit::Array &params, bool fHelp);
...
public:
    ...
    static json_spirit::Value execute(const std::string &method, const json_spirit::Array &params) {
        return CRPCTable::execute(method, params);
    }
};
#endif
