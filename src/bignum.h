...
public:
    ...
    */
    ...
    void setuint64(uint64_t n) { // Use BN_set_word if word size is sufficient for uint64_t
    ...
    */
    ...
    friend const CBigNum operator-(const CBigNum &a) { // c = -a
        CBigNum r(a);
    ...
    friend const CBigNum operator<<(const CBigNum &a, unsigned int shift) { // c = a << shift
        CBigNum r;
